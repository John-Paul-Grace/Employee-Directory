        ...
        return (
            <div className="card width-18 border-primary">
                ...
                <div className="card-body bg-grey mx-2 mb-2 mt-1">
                    <h5 className="card-title font-weight-bold">{employee.name.first} {employee.name.last}</h5>
                    ...
                    <div className="card-title subTitleStyle">Location: <span className="textStyle">{employee.location.city}, {employee.location.country}</span></div>
                </div>
            </div>
        );
    }
